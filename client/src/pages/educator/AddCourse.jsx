...
const AddCourse = () => {
  ...
  const { backendUrl, getToken, fetchAllCourses, navigate } = useContext(AppContext)
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-4 max-w-md w-full text-gray-500'>
        ...
        <div className='flex flex-col gap-1'>
          ...
          <div>
            ...
            <button type='submit' disabled={isSubmitting} className='bg-black font-semibold text-white w-max pt-2.5 px-8 py-2 rounded my-4 disabled:bg-gray-400 disabled:cursor-not-allowed'>{isSubmitting ? "ADDING..." : "ADD"}</button>
